...
namespace EFPayroll
{
    public class EmployeeTest
    {
        ...
        {
            var e1 = new Employee("Hank", "Hill", 100, DateTime.Now.AddYears(-5).AddDays(-10));
            var e2 = new Employee("Hank", "Hill", 100, DateTime.Now.AddYears(-5).AddDays(-10));
        ...
        [Fact]
        public void TestEmployeeBadFirstName()
        {
            Assert.Throws<ArgumentException>(() => new Employee("$$", "Hill", 200, DateTime.Today));
        }
        [Fact]
        public void TestEmployeeBadLastName()
        {
            Assert.Throws<ArgumentException>(() => new Employee("Hank", "$$", 200, DateTime.Today));
        }
